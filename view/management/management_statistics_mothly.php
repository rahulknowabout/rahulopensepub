...
//print_r($deviceresult);die;
//echo $_SESSION['provider_id'];die;
//echo "hello";die;
...
$months_name = array(1 => 'Janaury', 2 => 'February', 3 => 'March', 4 => 'April', 5 => 'May', 6 => 'June', 7 => 'July', 8 => 'August', 9 => 'September', 10 => 'October', 11 => 'November', 12 => 'December');
$months_name_abb = array(1 => 'Jan', 2 => 'Feb', 3 => 'Mar', 4 => 'Apr', 5 => 'May', 6 => 'Jun', 7 => 'Jul', 8 => 'Aug', 9 => 'Sep', 10 => 'Oct', 11 => 'Nov', 12 => 'Dec');
//echo "<pre>";
//print_r($dayManagementStatistics);die;
/** Certificate **/
...
/*if(isset($_GET['type']) && $_GET['type']!= "") {
	...
	$search_array_implode['type'] = "type=".$_GET['type'];
...
if (count($search_array)>0) {
	  $pagination = pagination($count,'management_statistics_mothly.php?',$search_array);
	  $search_array_string = implode("&",$search_array_implode);
 }else {
 $pagination = pagination($count,'management_statistics_mothly.php?');
 $search_array_string ="";
 }
...
/*if(isset($_GET['type']) && $_GET['type']!= "") {
	...
	$search_array_implodel['type'] = "type=".$_GET['type'];
...
if (count($search_arrayl)>0) {
	  $paginationl = paginationl($countl,'management_statistics_mothly.php?',$search_arrayl);
	  $search_array_stringl = implode("&",$search_array_implodel);
 }else {
 $paginationl = paginationl($countl,'management_statistics_mothly.php?');
...
<div class="tab-content">
		...
		<div class="member_page">
			...
			<div class="filter_box">
				<div class="filter_data">
					<form method="post" action="../../controller/management/certificateB.php" name="certificate_issuance_history_form">
			...
			<table class="table">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th><a href="management_statistics_mothly.php?<?php echo $search_array_string."#certificate_issuance_history"; ?>">Issue Date ▲▼</a></th>
                    <th>User ID</th>
	...
	<div id="license_issuance_history" class="tab-pane fade in<?php if ($tabactive=="license") { ?> active <?php } ?>">
		<div class="member_page">
			...
			<div class="filter_box">
				<div class="filter_data">
					<form method="post" action="../../controller/management/licenseB.php" name="license_issuance_history_form">
						<div class="form-group row">
							<label class="col-sm-3">Period Search</label>
							<div class="col-md-9 col-sm-12">
								<div class="start_date">
			...
			<table class="table">
                <thead>
                  <tr>
                    <th>No.</th>
                    <th><a href="management_statistics_mothly.php?<?php echo $search_array_stringl."#license_issuance_history"; ?>">Issue Date ▲▼</a></th>
                    <th>User ID</th>
                    <th>Target Type</th>
                    <th>License ID</th>
                    <th>Book name</th>	
	...
	<div id="statistics" class="tab-pane fade in <?php if ($tabactive=="statistics") { ?>active<?php } ?>">
			...
			<div class="filter_box">
				<div class="filter_data">
					<form method="post" action="../../controller/management/month.php" name="month_statistics">
						<div class="form-group row">
							<label class="col-sm-3">&nbsp;</label>
							<div class="col-md-9 col-sm-12">
								<div class="row">
									<div class="col-sm-4 col-xs-4 Mobilebtn">
										<a href="#statistics" class="btn btn-info">Monthly Statistics</a>
									</div>
									<div class="col-sm-4 col-xs-4 Mobilebtn">
										<a href="management.php?type=statistics#statistics" class="btn btn-outline">Daily Statistics</a>
									</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-9 col-sm-12">
								<div class="row">
									<div class="col-sm-8 col-xs-8 Mobilebtn">
										  <select class="form-control" name="month_statistics_year" id="year">
										<!--  <script>
										  var myDate = new Date();
									...
									<div class="col-sm-4 col-xs-4 Mobilebtn"><button type="submit" name="month_statistics_submit" class="btn btn-info btn-lg btn-block">Search</button></div>									
								</div>
							 </div>	
						</div>						
					</form>
			...
			<div class="graph_row">
				<h2><b>Monthly Statistics</b> of <?php if (isset($_GET['year']) && $_GET['year'] != ""  ) { echo $_GET['year'];}else{  echo "2016"; } ?></h2>
                <?php if (isset($dayManagementStatisticsNew) && is_array($dayManagementStatisticsNew) && count($dayManagementStatisticsNew)>0) {
					...
					for($idg=1;$idg<=count($dayManagementStatisticsNew['certificates']);$idg++) {
								...
								$monthnamegraph = $months_name_abb[$idg];
								if ( isset($_GET['year']) && $_GET['year'] == $currentYear && $idg == $currentMonth ) {
									$dataPointsA[] = array(label => $monthnamegraph, y => $xaxis,color => "#83BFD7");
									$dataPointsB[] = array(label => $monthnamegraph, y => $yaxis,color => "#5992AD");
								}else {
						$dataPointsA[] = array(label => $monthnamegraph, y => $xaxis);
						$dataPointsB[] = array(label => $monthnamegraph, y => $yaxis);
								}
						$dataPointsAB[] = array(label => $monthnamegraph,y => $sumAB);
				}
				...
				<div class="Main_graph_area" id="Main_graph_area" style="height: 300px; width: 100%;">
					...
					<!--<img src="../../images/monthly_graph.jpg" alt="" title="" class="img-responsive" />-->
				</div>
                <div style="height: 100px; width: 100%;">
                <img src="../../images/signs_graph.jpg" alt="" title="" class="img-responsive"  style="float:right;"/>
                </div>
				<div class="Main_data_table monthly_plan">
						<div class="table-responsive">
