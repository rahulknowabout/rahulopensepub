        ...
        <div class="member_page">
            ...
            <form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4 col-sm-7"><input type="text" class="form-control" id="inputName" placeholder=""></div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 col-md-3 col-lg-2" for="inputEmail1">Email</label>
                  <div class="col-md-4 col-sm-7"><input type="email" class="form-control" id="inputEmail1" placeholder="" disabled></div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7"><input type="text" class="form-control" id="Cname" placeholder=""></div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 col-md-3 col-lg-2" for="Caddress">Company address</label>
                  <div class="col-sm-7"><input type="text" class="form-control" id="Caddress" placeholder=""></div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 col-md-3 col-lg-2" for="CPnumber">Company phone number</label>
                  <div class="col-sm-7"><input type="text" class="form-control" id="CPnumber" placeholder="" ></div>
                </div> 
                <div class="form-group btn_add">
                  <label class="col-sm-4 col-md-3 col-lg-2">Transfer of <br/>membership rights</label>
                    <div class="col-md-4 col-sm-7">
                    <a href="#" class="btn btn-info">Permission for transfer</a>
                </div>
                </div>                
...
English alphanumeric characters within 8 to 20 characters</p>
       ...
       <div class="input-group2">
          <div class="form-group">
           <input class="form-control" id="pwd" placeholder="New Password" required="" type="Password"><span class="msg okay"><i class="fa fa-check-circle"></i></span>
          </div>
          <div class="form-group"> <input class="form-control" id="repeatpwd" placeholder="Re-enter the Password" required="" type="password">
          <span class="msg not_okay"><i class="fa fa-times-circle"></i></span>
           </div>
       </div>   
      <div style="height:20px;"></div>
