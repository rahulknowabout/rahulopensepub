...
<div id="Certificate_DRM" class="tab-pane fade in active">
    ...
    <div class="eBook_encryption">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-5">
                 <input type="text" name="tryfield" id="tryfield" value=""/>
                        ...
                        <span class="choose_date_span">
							<div id="remember" class="checkbox">
							  <label class="ui-checkbox">
								<input type="checkbox" value="option1" name="datecheckbox">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-5">
                    ...
                    <ul class="checkbox_inside">
                       <li>
                       <input id="s-option-1" name="LCP_AddFile" type="radio" checked>
                ...
                <div class="col-sm-7">
                    ...
                    <ul class="checkbox_inside">
                       <li>
                       <input id="s-option-file-1" name="LCP_AddFile" class="LCP_E" type="radio">
...
$(document).on('click', ".group_box input:radio", function(){
  ...
  var jvalidate_edit =  $("#certificate_form").validate({
     ignore: [],
                rules: {                                            
                        tryfield: { required:true
