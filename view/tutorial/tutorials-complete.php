...
The encrypted EPUB file can also be found in Tutorials> History.</p>
        <div class="Download_Period">
            ...
            <div class="scan_file">
                ...
                <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=http%3A%2F%2F<?php echo SITE_BASE_URL_FILE."/storage/epub/".$_GET['success']; ?>m%2F&choe=UTF-8" style="width:80px;height:80px;"/>
...
The encrypted EPUB file can also be found in Tutorials> History.</p>
        <div class="Download_Period">
            ...
            <div class="scan_file">
                ...
                <h3>Download the file at
                <a href="tutorials-download.php">http://opens.drm.nt/d4r87t</a>
