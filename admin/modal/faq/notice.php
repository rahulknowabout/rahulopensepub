...
$SQL = "INSERT INTO `opens_faq` (`notice_date`,`notice_title`,`notice_file`,`notice_content`,`notice_sort_date`)
...
$SQL = "Select * from opens_faq where id =".$id."";
	$res =  MySQL::query($SQL,true);
	return $res;
}
function noticeReadByTitle($title){
$SQL = "Select id from opens_faq where notice_title = '".$title."' ";
//echo $SQL;die; 
$res =  MySQL::query($SQL,true);
return $res;
}
function noticeReadByTitleExcept($title,$notice_id){
$SQL = "Select id from opens_faq where notice_title = '".$title."' AND id <> ".$notice_id." ";
//echo $SQL;die; 
$res =  MySQL::query($SQL,true);
return $res;
}
...
$SQL = "Select * from opens_faq  ORDER BY UNIX_TIMESTAMP(notice_sort_date) DESC LIMIT ".$limitstart.",".$limitend.";";
			  // echo $SQL; die;
      $res =  MySQL::query($SQL);
	  //echo "<pre>";
	 // print_r($res);die;
...
function countNotice(){
	$SQL = "Select count(*) as opens_notice from opens_faq";
	$res =  MySQL::query($SQL,true);
	return $res;
}
...
$SQL = "Select * from opens_faq where notice_title like '%".$notice_title."%' ORDER BY UNIX_TIMESTAMP(notice_sort_date) DESC Limit ".$limitstart.",".$limitend." ;";
			  // echo $SQL; die;
      $res =  MySQL::query($SQL);
	  //echo "<pre>";
	  //print_r($res);die;
...
function noticeSearchTitleCount($notice_title){
	$SQL = "Select count(*) as opens_notice from opens_faq where notice_title like '%".$notice_title."%'";
			  //echo $SQL; die;
      $res =  MySQL::query($SQL,true);
	  //echo "<pre>";
	  //print_r($res);die;
...
$SQL = "Select * from opens_faq where notice_content like '%\"insert\":\"%".$notice_content."%\"%' ORDER BY UNIX_TIMESTAMP(notice_sort_date) DESC Limit ".$limitstart.",".$limitend." ;";
			   //echo $SQL; die;
      $res =  MySQL::query($SQL);
	  //echo "<pre>";
	  //print_r($res);die;
...
function noticeSearchContentCount($notice_content){
	$SQL = "Select count(*) as opens_notice from  opens_faq where notice_content like '%insert:%".$notice_content."%%'";
			  // echo $SQL;
      $res =  MySQL::query($SQL,true);
	  //echo "<pre>";
	  //print_r($res);die;
