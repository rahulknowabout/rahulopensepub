...
header("location: ../../view/faq/list.php?search_notice=title&searchinput_name=".$_POST['searchinput_name'].""); 
}
if (isset($_POST['search_notice']) && $_POST['search_notice'] == 'content') {
//customerSearchEmail($cleanedPOST['searchinput_name']);
header("location: ../../view/faq/list.php?search_notice=content&searchinput_name=".$_POST['searchinput_name'].""); 
}
}
?>