...
header("location: ../../view/tutorial/tutorial_usage_history.php?contract_start_date=".$contract_start_date."&contract_end_date=".$contract_end_date."&search_category=".$search_category."&serach_name=".$serach_name.""); 
