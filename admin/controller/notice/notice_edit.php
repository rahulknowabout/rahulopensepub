...
if(isset($_POST['first_form']) && $_POST['first_form'] == 'first_form' ) {
	...
	$duplicate_notice = noticeReadByTitleExcept($cleaned['notice_title'],$cleaned['notice_id']);
...
//setNoticeContent($cleaned['update_id'],$postarray['notice_content']);
